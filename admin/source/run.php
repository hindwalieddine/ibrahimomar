...
<tr>
<td>
<input type="button" style="width:300px" onclick="if(document.form.name.value!=''){ run('deleteTableAndItsFiles'); }else{ alert('Fill The Input Field With The Table Name'); }" value="Delet Table And Its Files" >
**
</td>
</tr>
<tr>
<td>
<input type="button" style="width:300px" onclick="run('deleteAllPrivilegesAuto')" value="Delete Privileges" >
</td>
</tr>
<tr>
<td>
<input type="button" style="width:300px" onclick="run('addAllPrivilegesAuto')" value="Add Privileges" >
</td>
</tr>
<tr>
<td>
<input type="button" style="width:300px" onclick="run('clearAdmin')" value="Clear Admin" >
</td>
</tr>
<tr>
<td>
...
<table>
<td>** </td><td>: Table Name In Input Field Requierd</td>
</td>
</tr>
</table>
</html>