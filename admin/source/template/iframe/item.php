...
?>									
									...
									<td>
									<img style="display:none" class="icon view_icon" src="../public/design-images/view_icon.png" onclick="window.open('viewItem.php?id=<?php echo $value[$keyId]; ?>&table=<?php echo $table; ?>')" >
									</td>
									<td >
